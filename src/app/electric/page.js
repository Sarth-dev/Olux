...
export default function electricBikesSection() {
  return (
   <>
   <NavBar/>
  <ElectricBanner/>
     <section className="max-w-7xl bg-gray-800  mx-auto px-4 py-12">
      <h2 className="text-3xl font-bold mb-8">Electric Bikes</h2>
        ...
        {electricBikes.map((bike, index) => (
          ...
          >
            ...
            <div className="bg-gray-50 px-4 py-4 rounded-b-xl">
              ...
              <a href="/product">
              <button className="mt-3 w-full border border-cyan-500 text-cyan-500 hover:bg-cyan-500 hover:text-white transition font-semibold rounded-md py-1.5">
                Buy
              </button></a>
            </div>
          </div>
